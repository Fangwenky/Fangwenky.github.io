export const articles = [
    {
        ...
        "category": "生活",
        "type": "html",
        "content": "<h2>Fang wenky 的碎碎念</h2>\n<p>大二专业分流后也是有一段时间了，经历了三个星期的小学期网页开发，又经历了两个星期多的早八折磨，到了十一跟前，人也是忙的有些疲惫，可能晚睡早起，天气转凉，加上许多忙碌的事务和一些上火，还是身体抱恙，难受了起来。 想着十一也快要来了，也想趁着假期休息休息，把自己的一些还没有太多时间做的快要结项的一些项目趁机处理一下，也算是整理一下这些时间一直积攒着的杂务，希望能有一个更好的新的开始。</p>\n<p>今晚也是心血来潮，决定做这样一个个人主页，于是乎就在 push AI 反复修改的重复之下把这个网页搭建的初见雏形，虽然还是很简陋，但是后面还会有很多时间去修补和完善的……吧？ 希望我能用这样的一个个人主页，来记录和分享一些我的生活，我的体验，我的感想，希望我的一些想法和思考也就能给你们带来一些启示。</p>\n<p>当然，作为计算机学院的学生，许多开源的资料，大佬们的无偿分享，都让我受益匪浅，我最最最希望的，也就是能够用我的这样一个平台，进行一些分享，我会把一些自己做的小项目，自己收集的一些学习资料，自己总结的一些学习经验， 在这里，分享给大家，希望或多或少，可以对一些后来之人有一些帮助。我希望能帮助学弟学妹少走一些弯路，在这个容易陷入迷茫四处碰壁的大学生活，一个好的指引，我相信会让人受益匪浅。</p>\n<p>希望我以后能把这个网站做的内容更丰富，功能更完善一点，希望今天 AI 写下的史山不会让以后的我试图给今天的我一个大逼兜。</p>\n<p>希望我们都有美好光耀的未来。</p>\n"
    },
    {
    ...
    },
    {
        ...
        "category": "课程资料",
        "type": "html",
        "content": "<h1>第1章 准备知识 (Preliminaries)</h1>\n<p>本章是全书的数学基础，其中<strong>条件期望</strong>是后续章节（特别是鞅、Markov链）的核心工具。</p>\n<h3>1.1 概率与极限</h3>\n<ul>\n<li><strong>【定义】事件的极限 (Page 2)</strong></li>\n<li>若 ${E_n, n \\ge 1}$ 是递增序列（$E_n \\subset E_{n+1}$），则 $\\lim_{n \\to \\infty} E_n = \\bigcup_{i=1}^{\\infty} E_i$。</li>\n<li>若 ${E_n, n \\ge 1}$ 是递减序列（$E_n \\supset E_{n+1}$），则 $\\lim_{n \\to \\infty} E_n = \\bigcap_{i=1}^{\\infty} E_i$。</li>\n<li><strong>【命题 1.1.1】概率的连续性 (Page 3)</strong></li>\n<li>对于单调（递增或递减）事件序列，$\\lim_{n \\to \\infty} P(E_n) = P(\\lim_{n \\to \\infty} E_n)$。</li>\n<li><strong>【命题 1.1.2】Borel-Cantelli 引理 (Page 3)</strong></li>\n<li>若 $\\sum_{i=1}^{\\infty} P(E_i) &lt; \\infty$，则 $P(\\text{无穷多个 } E_i \\text{ 发生}) = 0$。</li>\n<li><strong>【命题 1.1.3】Borel-Cantelli 引理的逆 (Page 3)</strong></li>\n<li>若 $E_1, E_2, \\dots$ 是<strong>独立</strong>事件，且 $\\sum_{i=1}^{\\infty} P(E_i) = \\infty$，则 $P(\\text{无穷多个 } E_i \\text{ 发生}) = 1$。</li>\n</ul>\n<h3>1.2 随机变量</h3>\n<ul>\n<li><strong>【定义】分布函数 (Page 4):</strong> $F(x) = P{X \\le x}$。</li>\n<li><strong>【定义】独立性 (Page 5):</strong> 若对于任意实数集 $A, B$，有 $P{X \\in A, Y \\in B} = P{X \\in A}P{Y \\in B}$，则 $X$ 和 $Y$ 独立。</li>\n</ul>\n<h3>1.3 期望值</h3>\n<ul>\n<li><strong>【定义】期望 (Page 5):</strong> $E[X] = \\int_{-\\infty}^{\\infty} x dF(x)$。</li>\n<li><strong>【公式】指示变量法 (Page 6 - 例1.3 A):</strong></li>\n<li>将 $X$ 写成指示变量之和 $X = \\sum X_i$，其中 $X_i$ 为 Bernoulli 变量。这是解决匹配问题（Matching Problem）的关键技巧。</li>\n</ul>\n<h3>1.4 矩母函数 (MGF)</h3>\n<ul>\n<li><strong>【定义】矩母函数 (Page 9):</strong> $\\phi(t) = E[e^{tX}]$。</li>\n<li><strong>【性质】</strong> $\\phi^{(n)}(0) = E[X^n]$。</li>\n<li><strong>【例 1.4 (B)】独立随机变量和的矩母函数 (Page 11):</strong></li>\n<li>若 $X_1, \\dots, X_n$ 独立，则 $\\phi_{\\sum X_i}(t) = \\prod \\phi_{X_i}(t)$。</li>\n</ul>\n<h3>1.5 条件期望 (全书核心)</h3>\n<ul>\n<li><strong>【定义】条件期望 (Page 12):</strong></li>\n<li>离散情形: $E[X|Y=y] = \\sum_x x P{X=x | Y=y}$。</li>\n<li>连续情形: $E[X|Y=y] = \\int_{-\\infty}^{\\infty} x f(x|y) dx$。</li>\n<li><strong>【定理】双重期望公式 (Page 12 - 公式 1.5.1):</strong></li>\n<li>$$E[X] = E[E[X|Y]]$$</li>\n<li><strong>解释:</strong> $E[X|Y]$ 是随机变量 $Y$ 的函数，对其再求期望即得 $E[X]$。</li>\n<li><strong>【公式】条件方差公式 (Page 13 - 例1.5 A中推导):</strong></li>\n<li>$\\text{Var}(X) = E[\\text{Var}(X|Y)] + \\text{Var}(E[X|Y])$。</li>\n<li><strong>【典型例题】</strong></li>\n<li><strong>例 1.5 (A) 随机个随机变量之和 (Page 13):</strong> 若 $N$ 是随机变量，$X_i$ 独立同分布，求 $\\sum_{i=1}^N X_i$ 的期望与方差。</li>\n<li><strong>例 1.5 (C) 匹配问题再访 (Page 14):</strong> 利用条件期望建立递归方程求解。</li>\n</ul>\n<h3>1.6 指数分布、无记忆性与失效率</h3>\n<ul>\n<li><strong>【定义】无记忆性 (Page 22 - 公式 1.6.2):</strong></li>\n<li>$P{X &gt; s+t | X &gt; t} = P{X &gt; s}$。</li>\n<li>指数分布是唯一具有无记忆性的连续型分布。</li>\n<li><strong>【定义】失效率函数 (Hazard Rate) (Page 23):</strong></li>\n<li>$\\lambda(t) = \\frac{f(t)}{1-F(t)}$。对于指数分布，失效率 $\\lambda(t) = \\lambda$ (常数)。</li>\n</ul>\n<h3>1.7 一些概率不等式</h3>\n<ul>\n<li><strong>【命题 1.7.1】Markov 不等式 (Page 24):</strong> $P{X \\ge a} \\le \\frac{E[X]}{a}$ (其中 $X \\ge 0$)。</li>\n<li><strong>【命题 1.7.2】Chernoff 界 (Page 24):</strong> 利用矩母函数给出尾概率的指数级上界。</li>\n<li><strong>【命题 1.7.3】Jensen 不等式 (Page 25):</strong> 若 $f$ 是凸函数，则 $E[f(X)] \\ge f(E[X])$。</li>\n</ul>\n<h3>1.8 极限定理</h3>\n<ul>\n<li><strong>强大多数定律 (Page 25):</strong> 样本均值以概率 1 收敛于期望。</li>\n<li><strong>中心极限定理 (Page 25):</strong> 独立同分布和的标准化序列收敛于标准正态分布。</li>\n</ul>\n<hr />\n<h1>第2章 Poisson 过程</h1>\n<h3>2.1 Poisson 过程的定义</h3>\n<ul>\n<li><strong>【定义 2.1.1】计数过程 (Page 36):</strong></li>\n<li>$N(t)$ 表示到时刻 $t$ 为止发生的事件总数。满足：(i) $N(0)=0$; (ii) 独立增量; (iii) 在任意长度 $t$ 区间中事件数的分布服从均值为 $\\lambda t$ 的 Poisson 分布。</li>\n<li><strong>【定义 2.1.2】构造性定义 (Page 37):</strong></li>\n<li>满足：(i) $N(0)=0$; (ii) 独立增量、平稳增量; (iii) $P(N(h)=1) = \\lambda h + o(h)$; (iv) $P(N(h) \\ge 2) = o(h)$。</li>\n<li><strong>【定理 2.1.1】</strong> 定义 2.1.1 与 定义 2.1.2 是等价的 <strong>(Page 37)</strong>。</li>\n</ul>\n<h3>2.2 到达间隔与等待时间</h3>\n<ul>\n<li><strong>【命题 2.2.1】到达间隔分布 (Page 39):</strong></li>\n<li>到达间隔序列 $X_1, X_2, \\dots$ 是独立同分布的，服从参数为 $\\lambda$ 的<strong>指数分布</strong>。</li>\n<li><strong>等待时间 $S_n$ (Page 39):</strong></li>\n<li>第 $n$ 个事件发生的时刻 $S_n = \\sum_{i=1}^n X_i$ 服从参数为 $(n, \\lambda)$ 的 <strong>Gamma 分布</strong>。</li>\n</ul>\n<h3>2.3 到达时间的条件分布</h3>\n<ul>\n<li><strong>【定理 2.3.1】次序统计量性质 (Page 41):</strong></li>\n<li>给定 $N(t)=n$，这 $n$ 个事件发生的时刻 $S_1, \\dots, S_n$ 的联合分布，与 $(0, t)$ 上 $n$ 个独立均匀分布随机变量的次序统计量的分布相同。</li>\n<li><strong>【典型例题】例 2.3 (A) (Page 41):</strong> 计算乘客在火车站的总等待时间期望，利用了上述定理。</li>\n</ul>\n<h3>2.4 非时齐 Poisson 过程</h3>\n<ul>\n<li><strong>【定义 2.4.1】 (Page 48):</strong></li>\n<li>强度函数 $\\lambda(t)$ 不再是常数。增量 $N(t+s) - N(t)$ 服从均值为 $m(t+s)-m(t)$ 的 Poisson 分布，其中 $m(t) = \\int_0^t \\lambda(s) ds$。</li>\n</ul>\n<h3>2.5 复合 Poisson 过程</h3>\n<ul>\n<li><strong>【定义】 (Page 50):</strong></li>\n<li>$X(t) = \\sum_{i=1}^{N(t)} Y_i$，其中 $N(t)$ 是 Poisson 过程，$Y_i$ 是独立同分布随机变量。</li>\n<li><strong>【矩公式】 (Page 51 - 例 2.5 A):</strong></li>\n<li>$E[X(t)] = \\lambda t E[Y_1]$</li>\n<li>$\\text{Var}(X(t)) = \\lambda t E[Y_1^2]$</li>\n</ul>\n<hr />\n<h1>第3章 更新理论 (Renewal Theory)</h1>\n<h3>3.1 引言与准备知识</h3>\n<ul>\n<li><strong>【定义】更新过程 (Page 60):</strong></li>\n<li>计数过程 ${N(t), t \\ge 0}$，其中到达间隔 $X_n$ 是独立同分布的非负随机变量，分布为 $F$。</li>\n<li><strong>【定义】更新函数 (Page 61):</strong></li>\n<li>$m(t) = E[N(t)]$。</li>\n</ul>\n<h3>3.2 N(t) 的分布</h3>\n<ul>\n<li><strong>【命题 3.2.1】更新方程 (Page 61 - 公式 3.2.3):</strong></li>\n<li>$m(t) = F(t) + \\int_0^t m(t-x) dF(x)$。这是更新理论的基础积分方程。</li>\n</ul>\n<h3>3.3 极限极限定理</h3>\n<ul>\n<li><strong>【命题 3.3.1】 (Page 62):</strong></li>\n<li>$N(t)/t \\to 1/\\mu$ (以概率 1 成立)，其中 $\\mu = E[X_n]$。</li>\n<li><strong>【定理 3.3.2】Wald 方程 (Page 64):</strong></li>\n<li>若 $X_n$ 独立同分布，$N$ 是对应于 $X_n$ 的停时且 $E[N]&lt;\\infty$，则 $E[\\sum_{i=1}^N X_i] = E[N]E[X]$。</li>\n<li><strong>【定理 3.3.4】基本更新定理 (Page 65):</strong></li>\n<li>$\\lim_{t \\to \\infty} \\frac{m(t)}{t} = \\frac{1}{\\mu}$。</li>\n</ul>\n<h3>3.4 关键更新定理及其应用</h3>\n<ul>\n<li><strong>【定理 3.4.1】Blackwell 定理 (Page 67):</strong></li>\n<li>对于非格点分布 $F$，$\\lim_{t \\to \\infty} [m(t+a) - m(t)] = \\frac{a}{\\mu}$。</li>\n<li><strong>【定理 3.4.2】关键更新定理 (Page 68):</strong></li>\n<li>若 $h(t)$ 直接 Riemann 可积，则 $\\lim_{t \\to \\infty} \\int_0^t h(t-x) dm(x) = \\frac{1}{\\mu} \\int_0^{\\infty} h(t) dt$。这是求极限分布的通用工具。</li>\n<li><strong>【典型应用】交替更新过程 (Page 71 - 例 3.4 A):</strong></li>\n<li>利用关键更新定理证明系统处于“开”状态的极限概率为 $\\frac{E[\\text{On}]}{E[\\text{On}] + E[\\text{Off}]}$。</li>\n</ul>\n<h3>3.5 延迟更新过程</h3>\n<ul>\n<li><strong>【定义】 (Page 76):</strong></li>\n<li>第一个到达间隔 $X_1$ 的分布 $G$ 与后续 $X_i$ 的分布 $F$ 不同。</li>\n<li><strong>【平衡更新过程】 (Page 76):</strong> 当 $G$ 取为平衡分布 $F_e(x) = \\int_0^x \\frac{1-F(y)}{\\mu} dy$ 时，过程变为平稳的。</li>\n</ul>\n<h3>3.6 更新报酬过程</h3>\n<ul>\n<li><strong>【定理 3.6.1】 (Page 82):</strong></li>\n<li>若每次循环获得报酬 $R_n$ 和时长 $X_n$，则长期平均报酬 $\\lim_{t \\to \\infty} \\frac{R(t)}{t} = \\frac{E[R]}{E[X]}$ (以概率1成立)。</li>\n<li><strong>【例 3.6 (C)】 (Page 85):</strong> 火车发车问题，展示了如何构造循环来计算平均费用。</li>\n</ul>\n<hr />\n<h1>第4章 Markov 链 (离散时间)</h1>\n<h3>4.1 引言与例子</h3>\n<ul>\n<li><strong>【定义】Markov 链 (Page 101 - 公式 4.1.1):</strong></li>\n<li>$P{X_{n+1}=j | X_n=i, X_{n-1}=i_{n-1}, \\dots} = P_{ij}$。即“将来只依赖于现在，而与过去无关”。</li>\n<li><strong>【典型例题】例 4.1 (A) M/G/1 排队系统 (Page 101):</strong></li>\n<li>利用顾客离去时刻作为嵌入点，将其转化为离散 Markov 链。</li>\n</ul>\n<h3>4.2 C-K 方程和状态分类</h3>\n<ul>\n<li><strong>【公式】Chapman-Kolmogorov 方程 (Page 104 - 4.2.1):</strong></li>\n<li>$P_{ij}^{n+m} = \\sum_{k=0}^{\\infty} P_{ik}^n P_{kj}^m$。</li>\n<li><strong>【定义】互通与类 (Page 104):</strong> 状态 $i$ 与 $j$ 互通 ($i \\leftrightarrow j$)。</li>\n<li><strong>【定义】常返与暂态 (Page 105):</strong></li>\n<li>常返 (Recurrent): 以概率 1 最终回到该状态。$\\sum P_{ii}^n = \\infty$。</li>\n<li>暂态 (Transient): 以正概率不再回来。$\\sum P_{ii}^n &lt; \\infty$。</li>\n</ul>\n<h3>4.3 极限定理</h3>\n<ul>\n<li><strong>【定义】周期性 (Page 105):</strong> 若从 $i$ 出发回到 $i$ 的步数只能是 $d$ 的倍数，则周期为 $d$。</li>\n<li><strong>【定理 4.3.3】极限概率的存在性 (Page 108):</strong></li>\n<li>对于不可约、非周期的常返链，极限概率 $\\pi_j = \\lim_{n \\to \\infty} P_{ij}^n$ 存在且独立于 $i$。</li>\n<li><strong>【方程】平稳分布 (Page 109 - 4.3.3):</strong></li>\n<li>$\\pi_j = \\sum_i \\pi_i P_{ij}$，且 $\\sum \\pi_j = 1$。</li>\n<li>$\\pi_j$ 也是状态 $j$ 的长期由访比例，且 $\\pi_j = 1/\\mu_{jj}$ (平均返回时间的倒数)。</li>\n</ul>\n<h3>4.4 转移与赌徒破产问题</h3>\n<ul>\n<li><strong>【命题 4.4.1】 (Page 115):</strong> 这一节主要讨论仅在暂态集合中停留的时间。</li>\n<li><strong>【例 4.4 (A)】赌徒破产问题 (Page 116):</strong></li>\n<li>利用差分方程求解在破产前达到财富 $N$ 的概率 $P_i = \\frac{1-(q/p)^i}{1-(q/p)^N}$。</li>\n</ul>\n<h3>4.5 分支过程</h3>\n<ul>\n<li><strong>【定义】 (Page 119):</strong> 描述种群繁衍的模型。</li>\n<li><strong>【灭绝概率】 (Page 120):</strong> 灭绝概率 $\\pi$ 是方程 $\\pi = \\sum_{j=0}^{\\infty} P_j \\pi^j$ 的最小非负解。若均值 $\\mu \\le 1$，则 $\\pi=1$。</li>\n</ul>\n<h3>4.6 Markov 链的应用</h3>\n<ul>\n<li>这节通过算法模型（如 MCMC 的初级形式）展示应用。</li>\n</ul>\n<h3>4.7 时间可逆的 Markov 链</h3>\n<ul>\n<li><strong>【定义】时间可逆 (Page 127):</strong></li>\n<li>若存在概率分布 $\\pi_i$ 满足 <strong>细致平衡方程</strong>：$\\pi_i P_{ij} = \\pi_j P_{ji}$，且 $\\sum \\pi_i = 1$，则该链是时间可逆的，且 $\\pi_i$ 为平稳分布。</li>\n<li><strong>【典型例题】例 4.7 (B) Metropolis 算法 (Page 128):</strong> 构造一个可逆 Markov 链来模拟任意分布。</li>\n</ul>\n<h3>4.8 半 Markov 过程 (Page 133)</h3>\n<ul>\n<li><strong>【定义】</strong> 状态转移遵循 Markov 链，但在每个状态的停留时间服从依赖于当前状态和下一状态的分布。</li>\n</ul>\n<hr />\n<h1>第5章 连续时间的 Markov 链</h1>\n<h3>5.2 连续时间 Markov 链</h3>\n<ul>\n<li><strong>【定义】 (Page 144):</strong></li>\n<li>过程 ${X(t), t \\ge 0}$，在状态 $i$ 停留的时间服从参数为 $v_i$ 的指数分布，转移到 $j$ 的概率为 $P_{ij}$。</li>\n<li>或者直接定义转移速率 $q_{ij} = v_i P_{ij}$。</li>\n</ul>\n<h3>5.3 生灭过程</h3>\n<ul>\n<li><strong>【定义】 (Page 145):</strong></li>\n<li>状态只能从 $n$ 转移到 $n+1$ (出生速率 $\\lambda_n$) 或 $n-1$ (死亡速率 $\\mu_n$)。</li>\n<li><strong>【例 5.3 (A)】 M/M/s 排队系统 (Page 146):</strong></li>\n<li>典型的生灭过程，出生率为常数 $\\lambda$，死亡率依赖于服务台数量。</li>\n</ul>\n<h3>5.4 Kolmogorov 微分方程</h3>\n<ul>\n<li><strong>【定理 5.4.3】向后方程 (Backward Equation) (Page 150):</strong></li>\n<li>$P'<em>{ij}(t) = \\sum</em>{k \\ne i} q_{ik} P_{kj}(t) - v_i P_{ij}(t)$。</li>\n<li><strong>【定理 5.4.4】向前方程 (Forward Equation) (Page 151):</strong></li>\n<li>$P'<em>{ij}(t) = \\sum</em>{k \\ne j} q_{kj} P_{ik}(t) - v_j P_{ij}(t)$。通常用于求解状态分布。</li>\n</ul>\n<h3>5.5 极限概率</h3>\n<ul>\n<li><strong>【平衡方程】 (Page 156 - 公式 5.5.3):</strong></li>\n<li>对于生灭过程或一般连续 Markov 链，极限概率 $P_j$ 满足：</li>\n<li>$\\text{离开速率} = \\text{进入速率}$</li>\n<li>$v_j P_j = \\sum_k P_k q_{kj}$。</li>\n<li><strong>【典型例题】例 5.5 (A) M/M/1 排队 (Page 158):</strong> 推导 $P_n = (\\lambda/\\mu)^n (1-\\lambda/\\mu)$。</li>\n</ul>\n<h3>5.6 时间可逆性</h3>\n<ul>\n<li><strong>【定理 5.6.1】 (Page 161):</strong></li>\n<li>连续时间链是时间可逆的，当且仅当 $\\pi_i q_{ij} = \\pi_j q_{ji}$。</li>\n<li><strong>推论:</strong> 所有的生灭过程都是时间可逆的。</li>\n<li><strong>【例 5.6 (A)】 M/M/1 的可逆性 (Page 163):</strong> 证明了 M/M/1 系统输出过程也是 Poisson 过程（Burke 定理）。</li>\n</ul>\n<h3>5.7 倒向链与排队网络 (Page 168)</h3>\n<ul>\n<li>介绍了 Jackson 网络等排队网络的乘积解形式。</li>\n</ul>\n<hr />\n<h1>第6章 鞅 (Martingales) - 仅 6.1 节</h1>\n<h3>6.1 鞅</h3>\n<ul>\n<li><strong>【定义】鞅 (Page 184 - 公式 6.1.1):</strong></li>\n<li>随机过程 ${Z_n, n \\ge 1}$ 称为鞅，若 $E[|Z_n|] &lt; \\infty$，且对于一切 $n$，有：</li>\n<li>$$E[Z_{n+1} | Z_1, \\dots, Z_n] = Z_n$$</li>\n<li><strong>直观含义:</strong> 公平赌博，基于当前信息，对未来的最佳预测就是当前值。</li>\n<li><strong>【典型例题 1】零均值随机游动 (Page 184):</strong></li>\n<li>若 $X_i$ 均值为 0，则 $Z_n = \\sum_{i=1}^n X_i$ 是鞅。</li>\n<li><strong>【典型例题 2】乘积鞅 (Page 184):</strong></li>\n<li>若 $X_i$ 独立且 $E[X_i]=1$，则 $Z_n = \\prod_{i=1}^n X_i$ 是鞅。</li>\n</ul>\n"
    },
    {
